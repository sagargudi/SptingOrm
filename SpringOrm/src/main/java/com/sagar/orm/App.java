...
System.out.println("---------------------------------------------------------------");
				...
				case 4:
					// taking input from user
					System.out.println("enter User id :"); // id
					int uid2 = Integer.parseInt(br.readLine()); // taking input storing in uid1
					Student s4= stu.deleteStudent(uid2);
					System.out.println("The deleted record "+uid2);
				
					break;
				case 5:
					// taking input from user
					System.out.println("enter User id :"); // id
					int uid3 = Integer.parseInt(br.readLine()); // taking input storing in uid
					System.out.println("enter UserName :"); // name
					String uname1 = br.readLine(); // taking input storing in uname
					System.out.println("enter User's City :"); // city
					String ucity1 = br.readLine(); // taking input and storing in ucity
					// creating the object of student
					...
					s5.setName(uname1);
					s5.setCity(ucity1);
					int r3 = stu.updateStudent(s5); // calling insert method
					System.out.println(r3 + "  Student updated");
					System.out.println("==========================================");
					System.out.println();
